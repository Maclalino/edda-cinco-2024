public class ProgramMuseu {
    public static void main(String[] args) {
        ...
        System.out.println("Museu Mast");
        AlgoritmoBusca andromeda = new AlgoritmoBusca(285964, "Andrômeda");
        int indice = andromeda.buscaBinaria(volumes, andromeda.getChave());
        andromeda.imprimirGuardaVolumes(andromeda.getNome(), andromeda.getChave(), indice);

        AlgoritmoBusca olhoNegro = new AlgoritmoBusca(199976, "Galáxia do Olho Negro");
        int indiceDois = olhoNegro.buscaBinaria(volumes, olhoNegro.getChave());
        olhoNegro.imprimirGuardaVolumes(olhoNegro.getNome(), olhoNegro.getChave(), indiceDois);

        AlgoritmoBusca hoag = new AlgoritmoBusca(323739, "Objeto de Hoag");
        int indiceTres = hoag.buscaBinaria(volumes, hoag.getChave());
        olhoNegro.imprimirGuardaVolumes(hoag.getNome(), hoag.getChave(), indiceTres);
    }
